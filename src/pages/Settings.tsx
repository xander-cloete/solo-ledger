...
export function Settings() {
  ...
  // Local form state. We seed it from the saved settings, then let the user
  // edit freely and save when ready.
  ...
  // When the saved settings load/change, refresh the form fields to match.
  useEffect(() => {
    setCurrencySymbol(settings.currencySymbol)
    setCurrency(settings.currency)
    setStartingBalance(String(settings.startingBalance))
  }, [settings.currencySymbol, settings.currency, settings.startingBalance])
